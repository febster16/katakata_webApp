<x-admin-master>
    @section('content')
        ...
        <h1>All Pending Comment List</h1>
        ...
        @if(session('rejected'))
            <div class="alert alert-danger">{{session('rejected')}}</div>
        @endif
                        ...
                        @foreach($comments as $comment)
                            ...
                            <tr>
                                ...
                                <td width="20%" class="text-center">
                                    <a href="{{ url('admin/comment/status/reject/'.$comment->id) }}" class="btn btn-danger" style="padding: 2px 10px">Reject</a>
                                    <a href="{{ url('admin/comment/status/approve/'.$comment->id) }}" class="btn btn-success" style="padding: 2px 10px">Approve</a>
